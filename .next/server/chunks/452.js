"use strict";exports.id=452,exports.ids=[452],exports.modules={4779:(t,e,i)=>{i.d(e,{R:()=>o});let o=[{id:"azadi",image:"/AZR.png",category:"tools",tags:["MUSIC","CATALOGUE MANAGEMENT"],status:"live",title:"Azadi Records",subtitle:"Music Catalogue System",client:"Azadi Records, Mumbai",year:"2024",description:"We took 100+ spreadsheets across artists, royalties, splits and ISRC codes and collapsed them into one unified catalogue system. Now expanding to all labels on the roster including Seedhe Maut, with an artist-facing app in development.",stat:"100+ spreadsheets → 1 system",problem:"Azadi Records were managing their entire catalogue - 32+ releases, multiple artists, complex royalty splits - across 6 disconnected spreadsheets. Every release meant hours of manual updates, and mistakes were inevitable.",built:"A centralised catalogue management system with a live overview dashboard, ISRC tracking, automated split calculations, and a licensor management module. Built in React with a Supabase backend.",result:"Onboarded in a single day. Expanding to every label on the Azadi roster. Artist-facing app in development.",resultStat:"100+ spreadsheets. One dashboard.",mockupSvg:`<svg viewBox="0 0 400 260" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    </svg>`}]},6101:(t,e,i)=>{i.r(e),i.d(e,{default:()=>l}),i(9510);var o=i(6621);let r={runtime:"edge",alt:"Our Work | Software & AI Automation Case Studies | GOATED.",size:{width:1200,height:630},contentType:"image/png"};async function l(t){let{__metadata_id__:e,...i}=t.params,l=(0,o.fillMetadataSegment)("/portfolio",i,"opengraph-image"),{generateImageMetadata:a}=r;function n(t,e){let i={alt:t.alt,type:t.contentType||"image/png",url:l+(e?"/"+e:"")+"?8dbd8055ed8c8e1a"},{size:o}=t;return o&&(i.width=o.width,i.height=o.height),i}return a?(await a({params:i})).map((t,e)=>{let i=(t.id||e)+"";return n(t,i)}):[n(r,"")]}},5675:(t,e,i)=>{i.r(e),i.d(e,{default:()=>l}),i(9510);var o=i(6621);let r={runtime:"edge",alt:"Our Work | Software & AI Automation Case Studies | GOATED.",size:{width:1200,height:630},contentType:"image/png"};async function l(t){let{__metadata_id__:e,...i}=t.params,l=(0,o.fillMetadataSegment)("/portfolio",i,"twitter-image"),{generateImageMetadata:a}=r;function n(t,e){let i={alt:t.alt,type:t.contentType||"image/png",url:l+(e?"/"+e:"")+"?8dbd8055ed8c8e1a"},{size:o}=t;return o&&(i.width=o.width,i.height=o.height),i}return a?(await a({params:i})).map((t,e)=>{let i=(t.id||e)+"";return n(t,i)}):[n(r,"")]}}};